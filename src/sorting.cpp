...
//-----
void sorting::swapValue(int* a, int* b)
{
    int* temp = a;
    a = b;
    b = temp;
...
void sorting::InsertionSort(int arr[], int* begin, int* end)
{
...
void sorting::IntrosortUtil(int arr[], int* begin, int* end,
                   int depthLimit)
{
    ...
    if (size < 16) {
        InsertionSort(arr, begin, end); //FIXME
        return;
    }
...
void sorting::Introsort(int arr[], int* begin, int* end)
{
...
void sorting::heapify(int arr[], int n, int i) //FIXME name
{
